...
Deserialize.instructions = function(instructions) {
  ...
  instructions.forEach(instruction => {
    ...
    if (index === 0) {
      deserializedInstructions.push(new RUN());
    }
    else if (index < 19) {
      deserializedInstructions.push(new ADD(index - 1));
    }
    else if (index === 19) {
      deserializedInstructions.push(new COPY(0, 0));
    }
    else if (index < 35) {
      deserializedInstructions.push(new COPY(index - 16, 0));
    }
    else if (index === 35) {
      deserializedInstructions.push(new COPY(0, 1));
    }
    else if (index < 51) {
      deserializedInstructions.push(new COPY(index - 32, 1));
    }
    else if (index === 51) {
      deserializedInstructions.push(new COPY(0, 2));
    }
    else if (index < 67) {
      deserializedInstructions.push(new COPY(index - 48, 2));
    }
    else if (index === 67) {
      deserializedInstructions.push(new COPY(0, 3));
    }
    else if (index < 83) {
      deserializedInstructions.push(new COPY(index - 64, 3));
    }
    else if (index === 83) {
      deserializedInstructions.push(new COPY(0, 4));
    }
    else if (index < 99) {
      deserializedInstructions.push(new COPY(index - 80, 4));
    }
    else if (index === 99) {
      deserializedInstructions.push(new COPY(0, 5));
    }
    else if (index < 115) {
      deserializedInstructions.push(new COPY(index - 96, 5));
    }
    else if (index === 115) {
      deserializedInstructions.push(new COPY(0, 6));
    }
    else if (index < 131) {
      deserializedInstructions.push(new COPY(index - 112, 6));
    }
    else if (index === 131) {
      deserializedInstructions.push(new COPY(0, 7));
    }
    else if (index < 146) {
      deserializedInstructions.push(new COPY(index - 127, 7));
    }
    else if (index === 146) {
      deserializedInstructions.push(new COPY(0, 8));
    }
    else if (index < 163) {
      deserializedInstructions.push(new COPY(index - 144, 8));
    }
    else if (index < 175) {
      [addSize, copySize] = ADD_COPY(index, 163);

      deserializedInstructions.push(new ADD(addSize));
      deserializedInstructions.push(new COPY(copySize, 0));
    }
    else if (index < 187) {
      [addSize, copySize] = ADD_COPY(index, 175);

      deserializedInstructions.push(new ADD(addSize));
      deserializedInstructions.push(new COPY(copySize, 1));
    }
    else if (index < 199) {
      [addSize, copySize] = ADD_COPY(index, 187);

      deserializedInstructions.push(new ADD(addSize));
      deserializedInstructions.push(new COPY(copySize, 2));
    }
    else if (index < 211) {
      [addSize, copySize] = ADD_COPY(index, 199);

      deserializedInstructions.push(new ADD(addSize));
      deserializedInstructions.push(new COPY(copySize, 3));
    }
    else if (index < 223) {
      [addSize, copySize] = ADD_COPY(index, 211);

      deserializedInstructions.push(new ADD(addSize));
      deserializedInstructions.push(new COPY(copySize, 4));
    }
    else if (index < 235) {
      [addSize, copySize] = ADD_COPY(index, 223);

      deserializedInstructions.push(new ADD(addSize));
      deserializedInstructions.push(new COPY(copySize, 5));
    }
    else if (index < 239) {
      deserializedInstructions.push(new ADD(index - 235 + 1));
      deserializedInstructions.push(new COPY(4, 6));
    }
    else if (index < 243) {
      deserializedInstructions.push(new ADD(index - 239 + 1));
      deserializedInstructions.push(new COPY(4, 7));
    }
    else if (index < 247) {
      deserializedInstructions.push(new ADD(index - 243 + 1));
      deserializedInstructions.push(new COPY(4, 8));
    }
    else if (index < 256) {
      deserializedInstructions.push(new COPY(4, index - 247));
      deserializedInstructions.push(new ADD(1));
    }
    else {
