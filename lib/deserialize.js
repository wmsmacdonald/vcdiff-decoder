...
Deserialize.window = function(delta, position) {

  let deltaLength, targetWindowLength, dataLength, instructionsLength, addressesLength;

  // parentheses are needed for assignment destructuring
  ({ value: deltaLength, position } = Deserialize.integer(delta, position));
